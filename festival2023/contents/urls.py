...
urlpatterns =[
    ...
    path('POST/guestbook/', views.GuestBookCreateView.as_view(), name='bookCreate'), #채연 -방명록생성
    path('GET/guestbook/', views.GuestBookListView.as_view(), name='bookList'), #채연 -방명록목록
]
